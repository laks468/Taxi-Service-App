...
import 'package:driver/datamodels/tripdetails.dart';
...
class _NewTripPageState extends State<NewTripPage> {
  ...
  void acceptTrip(){
    ...
    DatabaseReference historyRef = FirebaseDatabase.instance.reference().child('drivers/${FirebaseAuth.instance.currentUser.uid}/history/$rideID');
    historyRef.set(true);
  ...
  void topUpEarnings(int fares){
    ...
    DatabaseReference earningsRef = FirebaseDatabase.instance.reference().child('drivers/${FirebaseAuth.instance.currentUser.uid}/earnings');
